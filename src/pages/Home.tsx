            ...
            {moods.map((mood) => {
              ...
              return (
                <motion.div
                  ...
                  className={`flex flex-col items-center justify-center gap-3 rounded-full h-40 w-40 cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95 active:translate-y-0 hover:-translate-y-2 ${isSelected
